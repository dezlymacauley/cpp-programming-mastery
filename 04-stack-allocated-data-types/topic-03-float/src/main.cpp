...
int main() {
    ...
    println("The most negative number that a float can store: {}", -FLT_MIN);
    // The most negative number that a float can store: -1.1754944e-38

    println("The most positive number that a float can store: {}", FLT_MAX);
    // The most positive number that a float can store: 3.4028235e+38
